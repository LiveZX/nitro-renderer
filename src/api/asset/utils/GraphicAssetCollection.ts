...
import { GraphicAsset, GraphicAssetPalette, IGraphicAsset, IGraphicAssetCollection } from '.';
import { IAsset, IAssetData, IAssetPalette } from '..';
import { RemoveFileExtension } from '../..';
...
export class GraphicAssetCollection implements IGraphicAssetCollection
{
    ...
    private addLibraryAsset(textures: Dict<Texture<Resource>>): void
    {
        ...
        for(const name in textures)
        {
            ...
            this._textures.set(RemoveFileExtension(name), texture);
        }
    }
