...
export class NitroBundle
{
    ...
    private _baseTexture: NitroBaseTexture = null;
    ...
    public parse(arrayBuffer: ArrayBuffer): void
    {
        ...
        while(fileCount > 0)
        {
            ...
            else
            {
                ...
                this._baseTexture = new NitroBaseTexture('data:image/png;base64,' + base64);
            }
    ...
    public get baseTexture(): NitroBaseTexture
    {
