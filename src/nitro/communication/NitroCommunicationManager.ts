import { ICommunicationManager, IConnection, IConnectionStateListener, IMessageConfiguration, IMessageEvent, NitroEvent, NitroManager, SocketConnectionEvent } from '@nitrots/api';
